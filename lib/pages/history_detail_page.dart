                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            helper.formatTanggalIndo(detail?.createdDate),
                            style: const TextStyle(fontSize: 13),
                          ),
                          const SizedBox(height: 4),
                          Text(
    ...
    return Container(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment
            .start, // ← supaya label & value rata atas saat value wrap
        children: [
          Text(label, style: const TextStyle(fontSize: 13)),
          const SizedBox(width: 12), // ← margin antara label dan value
          Expanded(
            // ← ini kuncinya, batasi lebar value
            child: Text(
              value,
              textAlign: TextAlign.right, // ← value tetap rata kanan
